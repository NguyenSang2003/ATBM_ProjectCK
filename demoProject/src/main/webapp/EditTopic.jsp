...
<div class="container-fluid pt-5">
    <form action="./editTopic" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input value="<%=topic.getName()%>" id="nameTopicInput" name="nameTopic" type="text" class="form-control"
                   aria-describedby="emailHelp" placeholder="Tên chủ đề">
            <small id="errTopic" class="form-text text-muted text-danger"><%=errNameTopic%>
            </small>
        </div>
        <div class="form-group">
            <label for="imageInterface">Ảnh đại diện</label>
            <input type="file" accept="image/*" class="form-control" name="interfaceImage" id="imageInterface"
                   placeholder="Ảnh đại diện">
            <img style="width: 400px;" id="showImage" class="mt-4" src="<%=topic.getImageInterface()%>"
                 alt="ảnh đại diện">
        </div>
